          ...
          <div className="collapse collapse-arrow bg-base-100 shadow-md mb-4 dark:bg-neutral">
            ...
            <div className="collapse-content text-light-color-text dark:text-dark-color-text">
              <p>
                ...
                depending on your location. You can check the details at
                checkout.
              </p>
            </div>
          </div>
          ...
          <div className="collapse collapse-arrow bg-base-100 shadow-md mb-4 dark:bg-neutral">
            ...
            <div className="collapse-content text-light-color-text dark:text-dark-color-text">
              <p>
                ...
                policy for unused items in their original packaging. For
                detailed guidelines, visit our Returns and Exchanges page.
              </p>
            </div>
          </div>
          <div className="collapse collapse-arrow bg-base-100 shadow-md mb-4 dark:bg-neutral">
