  ...
  return (
    <div className="mb-6 md:mb-10">
      ...
      <div className="collapse collapse-arrow bg-base-100 shadow-md mb-4 dark:bg-neutral">
        ...
        <div className="collapse-content text-light-color-text dark:text-dark-color-text">
          <p>
            Absolutely! We offer a hassle-free 30-day return and exchange policy
            for unused items in their original packaging. For detailed
      ...
      <div className="collapse collapse-arrow bg-base-100 shadow-md mb-4 dark:bg-neutral">
        ...
        <div className="collapse-content text-light-color-text dark:text-dark-color-text">
          <p>
            ...
            number. You can use it to track your shipment on our website or the
            courier’s portal.
          </p>
        </div>
      </div>
