...
const Newsletter = () => {
  return (
    <div className="news flex flex-col md:flex-row gap-6 items-center justify-between px-3 md:px-4 lg:px-8 xl:px-10 py-5 rounded-xl bg-white bg-opacity-10 dark:bg-black dark:bg-opacity-40">
      <div className="md:w-[60%] lg:flex-grow">
        <h1 className="font-bold text-3xl md:text-4xl mb-2 text-light-color-text dark:text-dark-color-text ">
          Subscribe to Our Newsletter
        </h1>
        <p className="text-xl md:text-2xl text-light-color-text dark:text-dark-color-text max-w-[800px] xl:max-w-[1000px]">
